...
def le_arquivo(arquivo):
	...
	* '-' representa transição vazia
	...
	with open(arquivo, 'r') as f:
		...
		alfabeto_pilha = f.readline().split()
        ...
        # [atual] [simb_lido] [ler_pilha] [empilhar] [destino]
        # q0 a - B q0
        # transicao = f.readline().split()
        # [0] = estado; [1] = simbolo; [2] = ler_pilha; [3] = desempilhar; [4:] = destinos
		for transicao in f:
			lista_destino = []
			t = transicao.split()
			for e in lista_estados:
				if e.nome == t[0]:
					...
					tripla = (lista_destino.copy(), t[2], t[3])
					e.transicao[t[1]] = tripla
			lista_destino.clear()
	f.close()
